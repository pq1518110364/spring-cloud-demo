...
public class CommonDAOInterfacePlugin extends PluginAdapter {
    DateFormat df5=DateFormat.getDateTimeInstance(DateFormat.MEDIUM,DateFormat.MEDIUM, Locale.CHINA);
    ...
    public boolean clientGenerated(Interface interfaze,
        ...
        interfaze.addJavaDocLine(" * @author: wei.xiang");
        interfaze.addJavaDocLine(" * @date: "+ df5.format(new Date()));
        interfaze.addJavaDocLine(" * @Description: " + interfaze.getType().getShortName() );
        interfaze.addJavaDocLine(" */");
