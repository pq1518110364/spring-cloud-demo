package com.bishop.common.excel;
...
public class ExcelUtil {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ExcelUtil.user user1 = new ExcelUtil.user("test1","test2");
        ExcelUtil.user user2 = new ExcelUtil.user("test1","test2");
        list.add(user1);
        list.add(user2);
        OutputStream outputStream = new FileOutputStream(new File("D:\\wrokspaces\\spring-cloud-demo\\test.xls"));
        exportExcel(map,list,outputStream);
        //importExcel()
    }
    @Data
